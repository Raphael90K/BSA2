...
int main() {
    ...
    sem_init(&sem_b, 0, 0); // Startwert 0: Thread B beginnt, gibt A frei und wartet
    ...
    FILE *csv_file = fopen("T2_sema_1P_min_times.csv", "w");
    if (!csv_file) {
    ...
    printf("Ergebnisse in 'T2_sema_1P_min_times.csv' gespeichert.\n");
    return 0;
}
